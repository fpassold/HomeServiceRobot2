...
echo "Launch script file for Home Service Robot"
...
sleep 3
echo "Launching RViz..."
xterm -e " rosrun rviz rviz -d src/my_robot/rvizConfig/rviz_home_service.rviz " &
sleep 5
echo "Launching add_markers (virtual objetcs)..."
